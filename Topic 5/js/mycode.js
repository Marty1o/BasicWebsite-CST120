...
function loops() {
    ...
    i = 0;
    do {
        console.log("Using Do While Loop getting a array value of " + shapes[i] + " at " + i);
        ++i;
    }while(i < shapes.length) 
...
function objects() {
    ...
    let person3 = new Person("Marry", "Jackson", 50, "Dean");
    ...
    function EnhancedPerson(firstName, lastName, age, occupation) {
        ...
        this.display = function () {
            console.log("This is an enhanced person " + this.firstName + " " + this.lastName + " who is of age " + this.age + " and is " + this.occupation);
        };
    }
